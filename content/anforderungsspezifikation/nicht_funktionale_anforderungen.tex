...
Effizienz, Änderbarkeit,Übertragbarkeit)
	...
	\begin{table}[H]
    	...
    	\begin{tabularx}{\textwidth}{l X l}
            ...
            \tabularnewline
        	\textbf{Bedienbarkeit (operability)} &  \textcolor{red}{Dominik's Mockup}Die Bedienung sollte sehr intuitiv sein. Für einen Helfer (Rolle: Mitglied) sollte die Anmeldungsroutine für ein Event innerhalb von 2 bis 3 Minuten abgewickelt werden können. 
